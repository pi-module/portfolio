...
/*
 * Pi::service('api')->portfolio(array('Text', 'keywords'), $keywords);
 * Pi::service('api')->portfolio(array('Text', 'description'), $description);
 * Pi::service('api')->portfolio(array('Text', 'alias'), $alias, $id, $model);
 */
