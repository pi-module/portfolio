...
/*
 * Pi::service('api')->portfolio(array('Resize', 'start'), $file, $src_path, $dst_path, $param_width, $param_height, $keep_original = true, $option = 'auto');
 */
...
{ 
     ...
     * @return true / false
     */
    public function start($file, $src_path, $dst_path, $param_width, $param_height, $keep_original = true, $option = 'auto')
    {
        // Set main paths
